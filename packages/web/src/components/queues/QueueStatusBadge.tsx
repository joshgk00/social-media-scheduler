...
export function QueueStatusBadge({ isPaused, postCount, seasonalStart, seasonalEnd }: QueueStatusBadgeProps) {
  ...
  if (postCount === 0) {
    return (
      <Badge variant="secondary" className="inline-flex items-center gap-1 text-xs font-semibold">
        Empty
      </Badge>
    );
  }
  ...
  return (
    <Badge variant="outline" className={cn('inline-flex items-center gap-1 text-xs font-semibold text-[--color-success]')}>
